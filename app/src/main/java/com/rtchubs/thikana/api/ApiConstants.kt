package com.rtchubs.thikana.api

import com.rtchubs.thikana.api.Api.API_REPO
import com.rtchubs.thikana.api.Api.API_VERSION
import com.rtchubs.thikana.api.Api.DIRECTORY_ACCOUNT
import com.rtchubs.thikana.api.Api.DIRECTORY_BANK
import com.rtchubs.thikana.api.Api.DIRECTORY_BANK_INFO
import com.rtchubs.thikana.api.Api.DIRECTORY_CARD
import com.rtchubs.thikana.api.Api.DIRECTORY_COMMON
import com.rtchubs.thikana.api.Api.DIRECTORY_CONNECT
import com.rtchubs.thikana.api.Api.DIRECTORY_PROFILE
...
object ApiEndPoint {
    ...
    const val GIFT_POINT_COLLECT = "/$API_REPO/set/thikana/merchant/shopvisitreward"
    const val SHOP_WISE_GIFT_POINT = "/$API_REPO/get/thikana/merchant/reward"
}
